    ...
    <>
      <Head>
        ...
        <link
          ...
          sizes="180x180"
          href="/assets/images/favicon/apple-touch-icon.png?v=1.0"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
          href="/assets/images/favicon/favicon-32x32.png?v=1.0"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="/assets/images/favicon/favicon-16x16.png?v=1.0"
        />
